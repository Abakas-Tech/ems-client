                  ...
                  {!isLoaded ? (
                    ...
                    <GoogleMap
                      ...
                      options={{
                        ...
                        zoomControl: false,
                        styles: [
                          { elementType: "geometry", stylers: [{ color: "#0A1F3D" }] },
                          { elementType: "labels.text.fill", stylers: [{ color: "#A9C6E8" }] },
                          { elementType: "labels.text.stroke", stylers: [{ color: "#041129" }] },
                          { featureType: "road", elementType: "geometry", stylers: [{ color: "#0054B8" }] },
                          { featureType: "water", elementType: "geometry", stylers: [{ color: "#003876" }] },
